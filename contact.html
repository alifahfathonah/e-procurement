					...
					<div class="row">
						<div class="col-md-12 main-wrap">
							<div class="main-content">
								<div class="container">
									<div class="row row-fluid pt-7 pb-7">
										<div class="col-sm-4">
											<div class="icon_element icon_element-outer icon-border icon_element-align-center">
												<div class="icon_element-inner">
													<i class="icon_element-icon fa fa-map-marker"></i>
												</div>
											</div>
											<div class="info">
												<h5 class="text-center">ADDRESS</h5>
												<p class="text-center">356 St. James Square, Covnet Garden,</p>
												<p class="text-center">England</p>
											</div>
										</div>
										<div class="col-sm-4">
											<div class="icon_element icon_element-outer icon-border icon_element-align-center">
												<div class="icon_element-inner">
													<i class="icon_element-icon fa fa-phone"></i>
												</div>
											</div>
											<div class="info">
												<h5 class="text-center">PHONE NUMMBER</h5>
												<p class="text-center">
													<span class="gold">+ (400)</span> 0123 456 789
												</p>
												<p class="text-center">
													<span class="gold">+ (800)</span> 0123 456 789
												</p>
											</div>
										</div>
										<div class="col-sm-4">
											<div class="icon_element icon_element-outer icon-border icon_element-align-center">
												<div class="icon_element-inner">
													<i class="icon_element-icon fa fa-envelope-o"></i>
												</div>
											</div>
											<div class="info">
													...
													<form>
														<div class="row">
															...
															<div class="col-sm-6">
																...
																<input type="email" name="your-email" value="" size="40" class="wpcf7-form-control wpcf7-text"/>
															</div>
															<div class="col-sm-12">
																<p>&nbsp;</p>
																Your Message<br/><br/>
								...
								<div class="row row-fluid mb-0 pt-0-pb-0">
									<div class="col-sm-12">
										<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d6304.829986131271!2d-122.4746968033092!3d37.80374752160443!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808586e6302615a1%3A0x86bd130251757c00!2sStorey+Ave%2C+San+Francisco%2C+CA+94129!5e0!3m2!1sen!2sus!4v1435826432051" width="100%" height="400" allowfullscreen></iframe>
									</div>
								</div>
							</div>
						</div>
