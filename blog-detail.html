...
<html lang="en-US">
	<head>
		...
		<title>Blog Detail | HTML Template</title>
								...
								<div class="single">
									<article class="hentry">
										<div class="hentry-wrap">
											<div class="entry-header">
												<h1 class="entry-title">Giambattista Valli</h1>
												<div class="entry-meta icon-meta">
													<span class="meta-date">
														<time datetime="2015-08-11T06:26:22+00:00">
															<i class="fa fa-calendar"></i>August 11, 2015
														</time>
													</span>
											...
											<div class="entry-content">
												...
												<p>
													<a href="#">
														<img class="aligncenter" src="images/blog-detail-img.jpg" alt="blog-detail-img" width="839" height="328"/>
													</a>
												</p>
									...
									<div class="author-info">
										<div class="author-avatar">
											<img alt='' src='images/author.png' class='avatar' height='100' width='100'/>
										</div>
										<div class="author-description">
											<h2 class="author-title">About sitesao</h2>
											<p class="author-bio">
												Vivamus sed maximus nulla, accumsan interdum eros. Pellentesque turpis magna, dignissim pharetra tempor eget, luctus id enim. Suspendisse condimentum sem risus.
											</p>
											<div class="author-social">
												...
												<span class="author-social-twitter">
													<a href="#" class="author-social-twitter" target="_blank">
														<i class="fa fa-twitter"></i>
													</a>
												</span>
												<span class="author-social-google-plus">
													<a href="#" class="author-social-google" target="_blank">
														<i class="fa fa-google"></i>
													</a>
												</span>
												<span class="author-social-linkedin">
													<a href="#" class="author-social-linkedin" target="_blank">
										...
										<div class="row related-post-items">
											<div class="related-post-item col-md-4 col-sm-6">
												<div class="entry-featured">
													<a href="#">
														<img width="800" height="800" src="images/blog/thumb_270x270.jpg" alt="blog-1"/>
													</a>
												</div>
											...
											<div class="related-post-item col-md-4 col-sm-6">
												<div class="entry-featured">
													<a href="#">
														<img width="700" height="350" src="images/blog/thumb_270x270.jpg" alt="blog-4"/>
													</a>
												</div>
												<div class="entry-info">
													<div class="entry-header">
											...
											<div class="related-post-item col-md-4 col-sm-6">
												<div class="entry-featured">
													<a href="#">
														<img width="700" height="350" src="images/blog/thumb_270x270.jpg" alt="blog-6"/>
													</a>
												</div>
												<div class="entry-info">
													<div class="entry-header">
