	...
	<body>
		...
		<div id="wrapper" class="wide-wrap">
			...
			<div class="heading-container heading-resize heading-no-button">
				<div class="heading-background heading-parallax" style="background-image: url('images/header-bg.jpg');">
					<div class="container">
						<div class="row">
							<div class="col-md-12">
							...
							<div class="main-content">
								<div class="row row-fluid">
									<div class="col-sm-12">
												...
												<div class="col-sm-8">
													<h2 class="text-center heading-nice-border">
														<span class="nice-border">
															...
															<span class="nice-border-content">WOMEN</span>
														</span>
													</h2>
													<p class="text-center">
										...
										<div class="row row-fluid mt-3 mb-0">
											<div class="col-sm-12">
												<a class="btn btn-black btn-align-center" href="#" style="padding:10px 40px 10px 40px;margin-top: 30px;">
												...
												<div class="col-sm-8">
													<h2 class="text-center heading-nice-border">
														<span class="nice-border">
															<span class="nice-border-bottom-right"></span>
															<span class="nice-border-top-left"></span>
															<span class="nice-border-content">MAECENAS</span>
														</span>
													</h2>
													<p class="text-center">
								...
								<div class="row row-fluid mt-6 pt-3">
									<div class="col-sm-12">
										<div class="commerce">
											<div class="row row-fluid mb-4">
												<div class="col-sm-2"></div>
												<div class="col-sm-8">
													<h2 class="text-center heading-nice-border">
														<span class="nice-border">
															<span class="nice-border-bottom-right"></span>
															<span class="nice-border-top-left"></span>
															<span class="nice-border-content">NULLA</span>
														</span>
													</h2>
													<p class="text-center">
