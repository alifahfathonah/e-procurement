...
<html lang="en-US">
	<head>
		...
		<title>Home Default | HTML Template</title>
						...
						<div class="col-md-12">
							<div class="main-content">
								...
								<div class="row row-fluid">
									<div class="col-sm-12">
										<div class="container">
											<div class="col-icon-border col-sm-4 pt-0 pb-3">
												<div class="icon_element icon_element-outer mb-0 pt-5 icon_element-align-center">
													<div class="icon_element-inner icon_element-size-lg">
														<span class="icon_element-icon fa fa-truck"></span>
													</div>
												</div>
												<h5 class="text-center">FREE DELIVERY WORDWIDE</h5>
												<p class="text-center">
													<span class="footer-service-text">World wide shipping<br/></span>
												</p>
											</div>
											<div class="col-icon-border col-sm-4 pb-3">
												<div class="icon_element icon_element-outer mb-0 pt-5 icon_element-align-center">
													<div class="icon_element-inner icon_element-size-lg">
														<span class="icon_element-icon fa fa-money"></span>
													</div>
												</div>
												<h5 class="text-center">FREE RETURN IN 90 DAYS</h5>
												<p class="text-center">
													<span class="footer-service-text">100% Money back – 30 Days</span>
												</p>
											</div>
											<div class="col-icon-border col-sm-4 pb-3">
												<div class="icon_element icon_element-outer mb-0 pt-5 icon_element-align-center">
													<div class="icon_element-inner icon_element-size-lg">
														<span class="icon_element-icon fa fa-life-ring"></span>
													</div>
												</div>
												<h5 class="text-center">BEST SUPPORT</h5>
												<p class="text-center">
													<span class="footer-service-text">Fast &amp; pro 24/7</span>
												</p>
											</div>
										</div>
									</div>
								</div>
								<div class="row row-fluid mb-6 pt-8">
									<div class="col-sm-12">
										<div class="container">
											<div class="col-sm-4">
								...
								<div class="container">
									<div class="row row-fluid">
										<div class="col-sm-12">
											<h2 class="mb-5 heading-nice-border text-center">
												<span class="nice-border">
													<span class="nice-border-bottom-right"></span>
													<span class="nice-border-top-left"></span>
													<span class="nice-border-content">FEATURED PRODUCTS</span>
												</span>
											</h2>
											<div class="tta-container">
												<div class="general tta tta-spacing-1 tabs-border tta-controls-align-center">
													<div class="tta-tabs-container">
														<ul class="nav nav-tabs tta-tabs-list">
													    	<li class="tta-tab active">
													    		<a data-toggle="tab" href="#tab-1">WOMEN&acute;S</a>
													    	</li>
													    	<li class="tta-tab">
													    		<a data-toggle="tab" href="#tab-2">MAN&acute;S</a>
													    	</li>
													    	<li class="tta-tab">
													    		<a data-toggle="tab" href="#tab-3">ACCESSORIES</a>
													    	</li>
													  	</ul>
													  	<div class="tab-content mt-4">
														    <div id="tab-1" class="tab-pane fade in active">
														    	<div class="caroufredsel product-slider" data-height="variable" data-scroll-fx="scroll" data-scroll-item="1" data-visible-min="1" data-visible-max="4" data-responsive="1" data-infinite="1" data-autoplay="0" data-circular="1">
																	<div class="caroufredsel-wrap">
																		<div class="commerce commerce-lookbok columns-4">
																						...
																						<figure>
																							<div class="product-wrap">
																								...
																								<div class="shop-loop-actions">
																									<a href="#" class="add_to_cart_button product_type_simple product_type_simple">
																										View
																									</a>
																						...
																						<figure>
																							<div class="product-wrap">
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-8"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-8alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
																						...
																						<figure>
																							<div class="product-wrap">
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-9"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-9alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
																						...
																						<figure>
																							<div class="product-wrap">
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-10"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-10alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
																						...
																						<figure>
																							<div class="product-wrap">
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-11"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-11alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
																						...
																						<figure>
																							<div class="product-wrap">
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-14"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-14alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
																						...
																						<figure>
																							<div class="product-wrap">
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-7"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-7alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
																						...
																						<figure>
																							<div class="product-wrap">
																								...
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-12"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-12alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
																						...
																						<figure>
																							<div class="product-wrap">
																								<div class="product-images">
																									<div class="shop-loop-thumbnail shop-loop-front-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400.jpg" alt="Product-13"/>
																										</a>
																									</div>
																									<div class="shop-loop-thumbnail shop-loop-back-thumbnail">
																										<a href="#">
																											<img width="400" height="450" src="images/product/thumb_400x400_alt.jpg" alt="Product-13alt"/>
																										</a>
																									</div>
																								</div>
																								<div class="shop-loop-actions">
								...
								<div class="row hot-deal">
									<div class="col-sm-12">
										<h2 class="text-center heading-nice-border white">
											<span class="nice-border">
												<span class="nice-border-bottom-right"></span>
												<span class="nice-border-top-left"></span>
												<span class="nice-border-content">HOT DEAL OF THE WEEK</span>
											</span>
										</h2>
										<div class="container">
											<div class="row row-fluid mb-0 pt-5">
												<div class="col-sm-12">
													<div class="commerce product-sale-countdown">
														<div class="product-sale-countdown-item nice-border-full">
															...
															<div class="nice-border-content row">
																<div class="col-md-7 col-sm-5 product-sale-countdown-image-wrap bg-cover">
																...
																<div class="col-md-5 col-sm-7 product-sale-countdown-info-wrap">
																	<div class="product-sale-countdown-info">
																		<h3 class="product-sale-countdown-title">
																			<a href="#">Pesto Cauliflower</a>
																		</h3>
																		...
																		<div class="product-sale-countdown-price">
																			<del><span class="amount">15.05&#36;</span></del> 
																		...
																		<div class="product-sale-date" 
																			 ...
																			 data-html="
																				...
																				&lt;div class=&quot;countdown-item&quot;&gt;
																					...
																					&lt;div class=&quot;countdown-item-label&quot;&gt;Minuts&lt;/div&gt;
																				&lt;/div&gt;
																				&lt;div class=&quot;countdown-item&quot;&gt;
																			...
																			data-toggle="countdown" data-end="2015/12/27">
										...
										<div class="col-sm-12">
											<h2 class="mb-5 heading-nice-border text-center">
												<span class="nice-border">
													<span class="nice-border-bottom-right"></span>
													<span class="nice-border-top-left"></span>
													<span class="nice-border-content">NEW ARRIVAL</span>
												</span>
											</h2>
											<div class="tta-container">
												<div class="general tta tta-spacing-1 tabs-border tta-controls-align-center">
													<div class="tta-tabs-container">
														<ul class="nav nav-tabs tta-tabs-list">
													    	<li class="tta-tab active">
													    		<a data-toggle="tab" href="#tab-4">LATEST PRODUCTS</a>
													    	</li>
													    	<li class="tta-tab">
													    		<a data-toggle="tab" href="#tab-5">BEST SELLER</a>
													    	</li>
													  	</ul>
													  	<div class="tab-content mt-4">
									...
									<div class="col-sm-12">
										<h2 class="text-center heading-nice-border white">
											<span class="nice-border">
												<span class="nice-border-bottom-right"></span>
												<span class="nice-border-top-left"></span>
												<span class="nice-border-content">DISCOVER MORE</span>
											</span>
										</h2>
										<div class="container">
											<div class="row row-fluid m-0 pt-5">
												<div class="col-sm-6">
													<div class="product-categories-grid">
														<div class="product-categories-grid-grid clearfix">
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Aliquam" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
																			<h3><a href="#">Aliquam </a></h3>
																			<a href="#">
																				<span class="product-category-grid-shop-now">
																					Shop Now
																				</span>
																			</a>
																		</div>
															...
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Donec" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
															...
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Maecenas" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
															...
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Nulla" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
																			<h3><a href="#">Nulla </a></h3>
																			<a href="#">
																				<span class="product-category-grid-shop-now">
																					Shop Now
																				</span>
												...
												<div class="col-sm-6">
													<div class="product-categories-grid">
														<div class="product-categories-grid-grid product-categories-grid-black clearfix">
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Tortor" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
																			<h3><a href="#">Tortor </a></h3>
																			<a href="#">
																				<span class="product-category-grid-shop-now">
																					Shop Now
																				</span>
															...
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Proin" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
																			<h3><a href="#">Proin </a></h3>
																			<a href="#">
																				<span class="product-category-grid-shop-now">
																					Shop Now
																				</span>
															...
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Various" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
															...
															<div class="product-category-grid-item">
																<div class="product-category-grid-item-wrap">
																	<div class="product-category-grid-featured-wrap">
																		<div class="product-category-grid-featured">
																			<img alt="Fusce" src="images/category/thumb_276x276.jpg">
																		</div>
																	</div>
																	<div class="product-category-grid-featured-summary">
																		<div class="product-category-grid-featured-summary-wrap">
																			<h3><a href="#">Fusce </a></h3>
																			<a href="#">
																				<span class="product-category-grid-shop-now">
																					Shop Now
																				</span>
								...
								<div class="container">
									<div class="row row-fluid mb-0 pt-7">
										<div class="col-sm-12">
											<h2 class="text-center heading-nice-border">
												<span class="nice-border">
													<span class="nice-border-bottom-right"></span>
													<span class="nice-border-top-left"></span>
													<span class="nice-border-content">OUR BLOG</span>
												</span>
											</h2>
														...
														<div class="posts-wrap masonry-wrap posts-layout-masonry row">
															<article class="masonry-item col-md-4 col-sm-6 hentry">
																<div class="entry-featured">
																	<a href="#">
																		<img width="800" height="800" src="images/blog/thumb_370x370.jpg" alt="blog-1"/>
																	</a>
																</div>
															...
															<article class="masonry-item col-md-4 col-sm-6 hentry">
																<div class="entry-featured">
																	<a href="#">
																		<img width="800" height="800" src="images/blog/thumb_370x370.jpg" alt="blog-2"/>
																	</a>
																</div>
																<div class="entry-info">
																	<div class="entry-header">
															...
															<article class="masonry-item col-md-4 col-sm-6 hentry">
																<div class="entry-featured">
																	<a href="#">
																		<img width="800" height="800" src="images/blog/thumb_370x370.jpg" alt="blog-3"/>
																	</a>
																</div>
																<div class="entry-info">
																	<div class="entry-header">
															...
															<div class="caroufredsel-wrap">
																<ul class="caroufredsel-items row">
																	<li class="caroufredsel-item col-md-2">
																		<a href="#">
																			<img alt="" src="images/client/thumb_188x110.jpg">
																		</a>
																	</li>
																	<li class="caroufredsel-item col-md-2">
																		<a href="#">
