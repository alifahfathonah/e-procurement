...
<html lang="en-US">
	<head>
		...
		<title>Home Parallax | HTML Template</title>
					...
					<div class="row">
						<div class="col-md-12">
							<div class="main-content">
								<div data-full-width="true" data-full-width-init="false" data-parallax="1.5" data-parallax-image="images/thumb_1600x800.jpg" class="row row-fluid mb-0 pb-0 row-o-full-height row-o-content-middle general parallax parallax-content-moving">
									<div class="col-sm-12">
										<div class="container">
											<div class="row row-fluid">
												<div class="col-sm-12">
													<h4 class="text-center white">#LOJA COLLECTIONS</h4>
													<div class="separator separator_align_center sep_width_10 sep_border_width_2 sep_pos_align_center separator_no_text sep_color_white mt-2">
													...
													<h1 class="text-center mb-4 white fz-5">
								...
								<div data-full-width="true" data-full-width-init="false" data-parallax="1.5" data-parallax-image="images/thumb_1600x800.jpg" class="row row-fluid mb-0 pb-0 row-o-full-height row-o-content-middle general parallax parallax-content-moving">
									<div class="col-sm-12">
										<div class="container">
											<div class="row row-fluid">
												<div class="col-sm-12">
													<h4 class="text-center gold">COLLECTIONS PATH #1</h4>
													<div class="separator separator_align_center sep_width_10 sep_border_width_2 sep_pos_align_center separator_no_text mt-2">
														<span class="sep_holder sep_holder_l">
															<span class="sep_line bd-gold"></span>
														</span>
														<span class="sep_holder sep_holder_r">
															<span class="sep_line bd-gold"></span>
														</span>
													</div>
													<h1 class="text-center mb-0 fz-5 gold">
														DOUBLE TAKES
													</h1>
													<div class="mb-4">
														<h4 class="text-center gold">
															Who did it better? You be the judge.
														</h4>
													</div>
													<a class="btn btn-primary-outline btn-align-center" href="#">
														<span>Discover</span>
													</a>
												</div>
											</div>
								...
								<div class="row-full-width"></div>
								<div data-full-width="true" data-full-width-init="false" data-parallax="1.5" data-parallax-image="images/thumb_1600x800.jpg" class="row mb-0 pb-0 row-o-full-height row-o-content-middle general parallax parallax-content-moving">
									<div class="col-sm-12">
										<div class="container">
											<div class="row row-fluid">
												<div class="col-sm-12">
													<h4 class="text-center white">COLLECTIONS PATH #2</h4>
													<div class="separator separator_align_center sep_width_10 sep_border_width_2 sep_pos_align_center separator_no_text sep_color_white mt-2">
														<span class="sep_holder sep_holder_l">
															<span class="sep_line"></span>
														</span>
													...
													<h1 class="text-center mb-0 fz-5 white">
														TROUSERS IN A TWIST
													</h1>
													<div class="mb-4">
														<h4 class="text-center white">
															Who says pant legs have to match?
														</h4>
													</div>
													<a class="btn btn-white-outline btn-align-center" href="#">
														<span>Discover</span>
								...
								<div data-full-width="true" data-full-width-init="false" data-parallax="1.5" data-parallax-image="images/thumb_1600x800.jpg" class="row row-fluid mb-0 pb-0 row-o-full-height row-o-content-middle general parallax parallax-content-moving">
									<div class="col-sm-12">
										<div class="container">
											<div class="row row-fluid">
												<div class="col-sm-12">
													<h4 class="text-center gold">COLLECTIONS PATH #3</h4>
													<div class="separator separator_align_center sep_width_10 sep_border_width_2 sep_pos_align_center separator_no_text mt-2">
														<span class="sep_holder sep_holder_l">
															<span class="sep_line bd-gold"></span>
														</span>
													...
													<div class="mb-4">
														<h4 class="text-center gold">
															Azzedine Alaia shows after Fashion Week.
														</h4>
													</div>
													<a class="btn btn-primary-outline btn-align-center" href="#">
														<span>Discover</span>
