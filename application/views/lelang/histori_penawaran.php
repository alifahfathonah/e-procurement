										...
										<div class="shop-loop list">
											...
											if($lelang==true){
														...
														$no++; 
														 ...
														 $tahapan_lelang = $this->M_Lelang->cek_tahapan_lelang($d->NomorLelang);
														 ...
														 $detail_lelang = $this->M_Lelang->detail_lelang2($d->NomorLelang);
														foreach ($detail_lelang as $k);
															...
															<figcaption>
																<div class="shop-loop-product-info">
																	...
																	<div class="info-meta">
																		...
																		Tahapan : '.$tahap.'<br>
																		Tanggal Penawaran : <time datetime="2015-04-27T03:29:49+00:00"> '.mdate('%d %M %Y ',strtotime($d->TanggalMenawar))."".substr($d->TanggalMenawar,11, 5).'</time><br>
																		Harga Penawaran : Rp '.buatrp($d->HargaPenawaran).'
																	...
																	<div class="list-info-meta clearfix">
																		<div class="list-action clearfix">
																			...
																			id="'.$k->NomorLelang.'">&nbsp&nbspSTATUS</a>
									...
									echo'					 
										...
										<li>
											...
											<div class="posts-thumbnail-content">
												<h4><a href="'.base_url('/index.php/pengumuman/detail_pengumuman/'.$r->NoPengumuman).'">'.$r->JudulPengumuman.'</a></h4>
												<time datetime="2015-04-27T03:29:49+00:00"> '.mdate('%d %M %Y ',strtotime($r->LastUpdate))."".substr($r->LastUpdate,11, 5).'</time>
												<a class="posts-thumbnail-readmore" data-toggle="modal" href="'.base_url('/index.php/pengumuman/detail_pengumuman/'.$r->NoPengumuman).'">Read more</a>
											</div>
										</li>
